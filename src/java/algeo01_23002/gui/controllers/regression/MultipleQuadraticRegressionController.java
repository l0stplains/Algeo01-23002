...
import static algeo01_23002.cli.Utilities.printParametricQuadraticRegression;
import static algeo01_23002.gui.Utilities.*;

public class MultipleQuadraticRegressionController {
    private Stage stage;
    private Scene scene;
    private Parent root;
    ...
    public void initialize(){
        ...
        String[] menuItems = {"Home", "Regression", "Multiple Quadratic Regression"};
        ...
        getPredictionButton.setOnMouseClicked(event -> {
            try {
                ...
                QuadraticRegressionResult result = new QuadraticRegressionResult(resultMatrix);
                ...
                Task<Integer> transformationTask = new Task<>() {
                    ...
                    protected Integer call() throws Exception {
                        ...
                        if(solution instanceof UniqueSolution){
                            QuadraticRegressionResult result = new QuadraticRegressionResult(((UniqueSolution) solution).getSolution());
                            ...
                            resultMatrixOutput.setText(printParametricQuadraticRegression(parametricSolution));
