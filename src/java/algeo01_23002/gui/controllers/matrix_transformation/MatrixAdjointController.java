...
public class MatrixAdjointController {
    private Stage stage;
    private Scene scene;
    private Parent root;
    ...
    public void initialize(){
        ...
        String[] menuItems = {"Home", "Matrix Transformation", "Matrix Adjoint"};
        ...
        getResultButton.setOnMouseClicked(event -> {
            try {
                ...
                resultMatrixOutput.setText(outputPaddedMatrix(firstMatrix.getAdjoint()));
