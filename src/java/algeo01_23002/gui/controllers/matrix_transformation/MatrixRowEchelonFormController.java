...
public class MatrixRowEchelonFormController {
    private Stage stage;
    private Scene scene;
    private Parent root;
    ...
    public void initialize(){
        ...
        String[] menuItems = {"Home", "Matrix Transformation", "Matrix Row Echelon Form"};
        ...
        getResultButton.setOnMouseClicked(event -> {
            try {
                ...
                resultMatrixOutput.setText(outputPaddedMatrix(firstMatrix.getRowEchelonForm()));
