...
public class GaussianEliminationMethodController {
    private Stage stage;
    private Scene scene;
    private Parent root;
    ...
    public void initialize(){
        ...
        String[] menuItems = {"Home", "Linear System Solver", "Gaussian Elimination Method"};
            ...
            try {
                ...
                Task<LinearSystemSolution> linearSystemSolutionTask = new Task<>() {
                    ...
                    protected LinearSystemSolution call() throws Exception {
                        ...
                        return solver.gaussianElimination(firstMatrix);
                    }
                };
