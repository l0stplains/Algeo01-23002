package algeo01_23002.gui.controllers.matrix_transformation;
...
public class MatrixInverseWithAdjointController {
    private Stage stage;
    private Scene scene;
    private Parent root;
    ...
    public void initialize(){
        ...
        String[] menuItems = {"Home", "Matrix Transformation", "Matrix Inverse with Adjoint"};
        ...
        getResultButton.setOnMouseClicked(event -> {
            try {
                ...
                resultMatrixOutput.setText(outputPaddedMatrix(firstMatrix.getInverseWithAdjoint()));
    ...
    public void onCrumbsAction(Breadcrumbs.BreadCrumbActionEvent event) throws IOException {
        ...
        if (selectedCrumb.equals("Home")) {
            ...
            stage.show();
        } else if (selectedCrumb.equals("Matrix Transformation")) {
